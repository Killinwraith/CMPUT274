...
def validate(password):
    ...
    #These if statements are created to recognize if the password typed was "Invalid", "Insecure", or a "Secure" password. 
...
# The variable was used for testing only
#main = input("Do you want a password generated (Y/N): ")

if __name__ == "__main__":
    """ The following was used for testing the code only
